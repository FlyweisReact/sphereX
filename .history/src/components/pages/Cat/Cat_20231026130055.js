  ...
  const fetchHandler = async () => {
    try {
      const { data } = await axios.get(
        "https://haroon-sphere-labour-bakend.vercel.app/getBanner"
      );
      setData(data);
    } catch (err) {
      console.log(err);
    ...
    const postHandler = async (e) => {
      ...
      try {
        const data = await axios.post(
          "https://haroon-sphere-labour-bakend.vercel.app/addBanner",
          {
            link: url,
            desc,
          }
  ...
  const deleteHandler = async (id) => {
    try {
      const data = await axios.delete(
        `https://haroon-sphere-labour-bakend.vercel.app/deleteBanner/${id}`
      );
      console.log(data);
