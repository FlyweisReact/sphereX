      ...
      >
        ...
        <tbody>
          {land.map((i, index) => (
            <tr key={index}>
              <td>
                <img src="https://akm-img-a-in.tosshub.com/businesstoday/images/story/202206/rice-fields-g83d1e5e51_1280-sixteen_nine.jpg?size=948:533" className="img-thmb" alt="" />
              </td>
              <td> {i.address} </td>
              <td> {i.size} sqm </td>
