  ...
  const fetchHandler = async () => {
    try {
      const { data } = await axios.get(
        "https://n6chil41tk.execute-api.ap-south-1.amazonaws.com/dev/contact"
      );
      setData(data);
    } catch (err) {
      console.log(err);
    ...
    const putHandler = async (e) => {
      ...
      try {
        const data = await axios.put(
          "https://n6chil41tk.execute-api.ap-south-1.amazonaws.com/dev/contact/63aaa8da8b8072204c0ac6b7",
          {
            address,
            email,
            phone,
